...
export default function ReportLinks({ type, id, nombre }) {
    return (
        <div className=' flex pl-0 p-4 pt-1 w-fit text-2xl font-Inter rounded items-center'>
            <button className="p-1 pb-2 rounded-lg text-white m-1 ml-0 transform transition-transform duration-200 hover:scale-105" style={{backgroundColor: '#4DB6AC'}}>
            ...
            <button className="p-1 pb-2 rounded-lg text-white m-1 transform transition-transform duration-200 hover:scale-105" style={{backgroundColor: '#03A9F4'}}>
            ...
            <button className="p-1 pb-2 rounded-lg text-white m-1 transform transition-transform duration-200 hover:scale-105" style={{backgroundColor: '#f2a518'}}>
            ...
            <button className="p-1 pb-2 rounded-lg text-white m-1 transform transition-transform duration-200 hover:scale-105" style={{backgroundColor: '#20262C'}}>
