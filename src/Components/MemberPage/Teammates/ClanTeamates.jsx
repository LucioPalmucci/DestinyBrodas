...
export default function ClanTeammates({ userId, membershipType }) {
    ...
    return (
        ...
        {playersClan && playersClan.length > 0 ? (
            <div className="text-white p-6 px-3 rounded-lg space-x-6 content-fit justify-between shadow-lg object-fill bg-center bg-cover" style={{ backgroundImage: `url('${API_CONFIG.BUNGIE_API}${playersClan[0]?.pgcrImg}')` }}>
